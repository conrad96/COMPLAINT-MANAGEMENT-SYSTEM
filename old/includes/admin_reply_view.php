...
<?php	echo "<h4>ADMIN : View Activity Details [Pending Complaint] </h4><p>";
$reply="SELECT * FROM complaints WHERE comp_ID=$compid ";
...
if($reply_fetch){
 ...
 <div id="wrap">
	...
	<h3 class="well">Complaint Details</h3><p>
<table class="table">
<tr><td>Forwarded Department:</td>
...
<tr>
<td>Date/Time</td>
<td><?php echo "{$reply_fetch['comp_dtime']} ";?></td>
</tr>
<tr>
<td>Complaint Body:</td>
<td><?php echo "{$reply_fetch['complaint_field']}";?></td>
</tr>
</table>
<?php } ?>
	</div> 
